// JavaScript for Anna Liza Bautista Portfolio
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (nameElement) {
        // Add subtle bounce effect on animation complete
        nameElement.addEventListener('animationend', function() {
            this.style.animation = 'none';
            setTimeout(() => {
                this.style.animation = 'subtleBounce 0.6s ease-out';
            }, 500);
        });
    }
    ...
    window.addEventListener('scroll', function() {
        ...
        if (heroSection && profileCircle) {
            profileCircle.style.transform = `translateY(${scrolled * 0.5}px)`;
        }
    });
